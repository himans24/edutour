<%-- 
    Document   : stdmenu
    Created on : 23 Sep, 2021, 4:13:08 PM
    Author     : himan
--%>
  ...
  <div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        <div class="iocn-link">
          <a href="#">
            ...
            <span class="link_name">New Register</span>
          </a>
          ...
          //out.println(e1);%>
        <ul class="sub-menu">
            <li><a class="link_name" href="#">Details</a></li>
          <li><a href="userdetails.jsp?id=<%= e1 %>">Personal Details</a></li>
          <li><a href="academicdetails.jsp?=<%=e1%>">Academic Details</a></li>
          <li><a href="coursedetails.jsp?=<%=e1%>">Course Details</a></li>
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">Update Details</a></li>
          <li><a href="spupdate.jsp?=<%=e1%>">Personal Details</a></li>
          <li><a href="saupdate.jsp?=<%=e1%>">Academic Details</a></li>
          <li><a href="scupdate.jsp?=<%=e1%>">Course Details</a></li>
        </ul>
      </li>
      <!--<li>
        <div class="iocn-link">
       ...
       <a href="ssearch.jsp">
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="ssearch.jsp?=<%=e1%>">Faculty Search</a></li>
        </ul>
      </li>
      <li>
        <a href="ebooks.jsp">
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="ebooks.jsp?=<%=e1%>"> E-books</a></li>
        </ul>
      </li>
      <li>
       <a href="scrapspace.jsp">
          <i class='bx bx-line-chart' ></i>
          <span class="link_name">Scrap Space</span>
        </a>
        <ul class="sub-menu blank">
            <li><a class="link_name" href="scrapspace.jsp?id=<%=e1%>>">Scrap Space</a></li>
        </ul>
      </li>
       <li>
       <a href="notice.jsp">
        ...
        <ul class="sub-menu blank">
          <li><a class="link_name" href="notice.jsp?=<%=e1%>">Notice</a></li>
        </ul>
      </li>
       <li>
       <a href="#">
          <i class='bx bx-line-chart' ></i>
          <span class="link_name">Online Exam</span>
        </a>
        <ul class="sub-menu blank">
          <li><a class="link_name" href="Test.jsp?=<%=e1%>">Test</a></li>
        </ul>
      </li>
     <!--<li>
        <div class="iocn-link">
      ...
      <div class="name-job">
        <div class="profile_name"><%
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/csdp","root","root");
                ...
                String  sql="select * from studentpersonalmaster where userid='"+e1+"'";
