<%-- 
    Document   : facebooks
    Created on : 29 Sep, 2021, 1:53:33 PM
    Author     : himan
--%>
...
String sql1="insert into ebooks(topic,link) values ('"+d+"','"+f+"')";
                PreparedStatement pst1=con.prepareStatement(sql1);
                int i=pst1.executeUpdate();
                if(i>0){
                    out.println("Ebook Uploaded");
                }
}
            
 if(request.getParameter("delete")!=null){
String sql2=" delete from ebooks where topic='"+h+"' ";
                PreparedStatement pst2=con.prepareStatement(sql2);
                int j=pst2.executeUpdate();
                if(j>0){
                    out.println("Ebook Deleted");
          }}
            }
                ...
                while(rs.next()){
                           ...
                           session.setAttribute("x",rs.getString(1));  
                ...
                //while(rss.next()){
                    %>
                     <tr>
                         <td><a style="text-decoration:none" href="ebooks.jsp?id=<=%rs.getString(1);%>"><%out.println(rs.getString(1));%></a></td>
...
<div class="form-popup" id="myForm">
    ...
    <input Type="submit" value="Upload" class="btnn" name="update">
