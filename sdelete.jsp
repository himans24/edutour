<%-- 
    Document   : sdelete
    Created on : 24 Sep, 2021, 6:36:10 PM
    Author     : himan
--%>
...
<!DOCTYPE html>
 ...
 .btn a{
  ...
  <%
            ...
            if(u!=null  ){
                String sql="delete from studentacademicmaster where userid='"+u+"'";
                PreparedStatement pst=con.prepareStatement(sql);
                int j=pst.executeUpdate();
                String sql1="delete from studentmaster where userid='"+u+"'";
                PreparedStatement pst1=con.prepareStatement(sql1);
                int i=pst1.executeUpdate();
                String sql2="delete from studentpersonalmaster where userid='"+u+"'";
                PreparedStatement pst2=con.prepareStatement(sql2);
                int h=pst2.executeUpdate();
                if(j>0 && i>0)
                {
